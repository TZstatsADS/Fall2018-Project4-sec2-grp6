...
def Find_Candidates_P_T_C(Candidates):
        ...
        if len(Candidate_List) >= 1:
            ...
            if Candidate == "Insertion":
                for candidate in Candidate_List:
                    ...
                    Candidates_Posibility.append({"Cor": correct, "p_t_c" : add_cpMinus1_tp/chars_cpMinus1})
                ...
                for candidate in Candidate_List:
                    ...
                    Candidates_Posibility.append({"Cor": correct, "p_t_c" : del_cpMinus1_cp/chars_cpMinus1_cp})
                ...
                for candidate in Candidate_List:
                    ...
                    Candidates_Posibility.append({"Cor": correct, "p_t_c" : rev_c_pre_c_pos/chars_c_pre_c_pos})
                ...
                for candidate in Candidate_List:
                    ...
                    Candidates_Posibility.append({"Cor": correct, "p_t_c" : sub_tp_cp/chars_cp})
...
print(Find_Candidates_P_T_C(Possible_Candidates))
